    ...
    <>
      <div className='mx-auto'>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          {
            toggle === true ?
              <Suspense fallback={<span className="loading loading-dots loading-xl"></span>}><AvailablePlayers fetchPlayers={fetchPlayers}></AvailablePlayers></Suspense> : <SelectedPlayers></SelectedPlayers>
          }
